const renderMenu = () => {
  ...
  menuItem1description.textContent =
    "Espresso: A short, strong drink served in an espresso cup.";
  ...
  menuItem2description.textContent =
    "Cold Brew Coffee: A smooth, cold beverage prepared by brewing freshly ground coffee in cold water. In the Cold Brew process, time makes up for heat.";
  ...
  menuItem3description.textContent =
    "Capuccino: A coffee drink consisting of espresso and a milk foam mixture. Served in a cappuccino cup.";
  ...
  menuItem4description.textContent =
    "Frappé: Rich iced coffee made of espresso, milk and ice. Flavoured syrup can be added. Mixed in a blender and served for example in a latte glass.";
  ...
  menuItem5description.textContent =
  ...
  menuItem6description.textContent =
    "Cookie: Freshly baked homemade cookies that are bold and fearless.";
